...
import 'package:wespark_form/helper.dart';
import 'package:wespark_form/models/project_form_model.dart';
import 'package:wespark_form/progress_button.dart';
                ...
                children: <Widget>[
                  ...
                  FormBuilderTextField(
                    ...
                    decoration: InputDecoration(
                        fillColor: const Color.fromRGBO(33, 33, 33, 0.08),
                  ...
                  FormBuilderRadioGroup(
                    ...
                    options: [
                      FormBuilderFieldOption(
                          value: 'Hôtel-Dieu Grace Healthcare',
                          child: Text('Hôtel-Dieu Grace Healthcare')),
                      FormBuilderFieldOption(
                          value: 'St. Clair College',
                          child: Text('St. Clair College')),
                      FormBuilderFieldOption(
                          value: 'University of Windsor',
                          child: Text('University of Windsor')),
                      FormBuilderFieldOption(
                          value: 'Windsor Regional Hospital',
                          child: Text('Windsor Regional Hospital')),
                      FormBuilderFieldOption(
                  ...
                  FormBuilderCheckboxGroup(name: "tags", options: const [
                    ...
                    FormBuilderFieldOption(
                        value: 'Graphic Design/Infographics',
                        child: Text('Graphic Design/Infographics')),
                    FormBuilderFieldOption(
                        value: 'Literature Review',
                        child: Text('Literature Review')),
                    FormBuilderFieldOption(
                    ...
                    FormBuilderFieldOption(
                        value: 'Planning & Organizing Events',
                        child: Text('Planning & Organizing Events')),
                  ]),
                  Text(
                ...
                child: ProgressButton(
                  ...
                  onPressed: () async {
                    ...
                    if (_formKey.currentState!.validate()) {
                      ...
                      var projectFormModel = ProjectFormModel(
                          affiliation: formData["otherAffiliation"] ??
                              formData["affiliation"],
                          description: formData["description"],
                          duration:
                              formData["otherDuration"] ?? formData["duration"],
